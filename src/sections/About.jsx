      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
        ...
        <section className="relative pt-15 pb-10 md:pt-20 md:pb-10 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
            <AoaText className="aoa-bg-1 absolute -top-8 -left-16 w-[520px] opacity-[0.04]" />
            <AoaText className="aoa-bg-2 absolute top-1/3 right-[-80px] w-[420px] opacity-[0.03]" />
            <AoaText className="aoa-bg-3 absolute bottom-0 left-1/3 w-[340px] opacity-[0.025]" />
          </div>
        ...
        <section className="py-12 md:py-16 relative">
          ...
          <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
            <AoaText className="aoa-bg-2 absolute top-1/2 left-1/2 w-[600px] -translate-x-1/2 -translate-y-1/2 opacity-[0.03]" />
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center mb-20">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-black glow-card">
                  <div className="relative" style={{ paddingBottom: '56.25%' }}>
                    <video
                      ...
                      aria-label="Azile Ngcwembe – AOA Craft founder video"
                    />
              ...
              {/* Story text side */}
              <div ref={storyRef} className={storyIn ? 'animate-fade-right' : 'opacity-0'}>
                ...
                <div className={`space-y-4 text-gray-600 leading-relaxed ${storyIn ? 'animate-fade-up delay-400' : 'opacity-0'}`}>
                  <p>
                    ...
                    Founded by <span className="font-semibold text-gray-800">Azile Ngcwembe</span> on a deep passion for pencil portraits,
                    the brand has since expanded into murals, canvas paintings, and graphic design —
            ...
            {/* ── Mission Section ───────────────────────────────────── */}
            <div ref={missionRef} className="relative my-20">
              ...
              <div className={`mission-card bg-gradient-to-r from-green-50 via-white to-emerald-50 rounded-3xl p-8 md:p-12 shadow-sm border border-green-100 ${missionIn ? 'animate-mission-in' : 'opacity-0'}`}>
                <div className="text-center max-w-3xl mx-auto">
                  ...
                  <div className={`relative ${missionIn ? 'animate-fade-up delay-500' : 'opacity-0'}`}>
                    <Quote className="absolute -top-4 -left-6 text-green-200 w-12 h-12" aria-hidden="true" />
