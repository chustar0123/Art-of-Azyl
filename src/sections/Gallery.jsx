...
// Graphic Design 
import graphic1 from '../assets/graphic-design1.JPG';
import graphic2 from '../assets/graphic-design2.PNG';
import graphic3 from '../assets/graphic-design3.JPG';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-center gap-3 md:gap-4">
              <button
                ...
                aria-label="View all artwork categories"
              >
                <LayoutGrid size={18} />
                <span>All Works</span>
              ...
              <button
                ...
                aria-label="View pencil portraits"
              >
                <Pencil size={18} />
              ...
              <button
                ...
                aria-label="View canvas paintings"
              >
                <ImageIcon size={18} />
